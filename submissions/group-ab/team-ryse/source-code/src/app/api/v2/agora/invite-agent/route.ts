...
Your behavior:
- You will START by delivering your opening statement to begin the trial
- After the opening, speak ONLY when: ruling on an objection, the user addresses the bench directly, or providing guidance on legal procedure
...
function getAgentConfig(
  ...
  const greeting =
    "The trial has begun. Today's agenda is to examine evidence and testimony regarding the validity of Ms. Fitria's termination. The plaintiffs are welcome.";
